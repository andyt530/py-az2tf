...
# REST or cli
    ...
    for i in range(0, count):
        ...
        try:
            ostyp=azr[i]["proprties"]["osType"]
            fr.write('\t os_type = "' +  ostyp + '"\n')
        except KeyError:
            pass
        try:
            creopt=azr[i]["proprties"]["creationData"]["createOption"]
        ...
        try:      
            creid=azr[i]["proprties"]["creationData"]["imageReference"]["id"]
            fr.write('\t source_resource_id = "' +  creid + '"\n')
        except KeyError:
            pass
        try:
            enc=azr[i]["proprties"]["encryptionSettings"]["enabled"]
            fr.write('\t encryption_settings {' + '"\n')
            fr.write('\t\t enabled = "' +  enc + '"\n')
            try:
                kekurl=azr[i]["proprties"]["encryptionSettings"]["keyEncryptionKey"]["keyUrl"]
                kekvltid=azr[i]["proprties"]["encryptionSettings"]["keyEncryptionKey"]["sourceVault"]["id"]
            ...
            try:
                dekurl=azr[i]["proprties"]["encryptionSettings"]["diskEncryptionKey"]["secretUrl"]
                dekvltid=azr[i]["proprties"]["encryptionSettings"]["diskEncryptionKey"]["sourceVault"]["id"]
        ...
        try:
            imid=azr[i]["proprties"]["creationData"]["imageReference"]["id"]
            fr.write('\t image_reference_id = "' +  imid + '"\n')
        except KeyError:
            pass        

        try:
            dsize=azr[i]["proprties"]["diskSizeGb"]
